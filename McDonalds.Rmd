...
index <- which(sol$solution != 0) #find indices of basic variables in the optimal solution
           
df[index,] #find entries for basic variables in the original data frame, df
```
